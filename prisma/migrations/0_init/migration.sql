...
-- AddForeignKey
ALTER TABLE "table_status" ADD CONSTRAINT "table_status_restaurant_id_fkey" FOREIGN KEY ("restaurant_id") REFERENCES "restaurant"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
